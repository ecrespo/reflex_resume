...
// Default dataset = the original rosencharts example, so <AreaChartFull /> with
// no props reproduces it.
...
export function AreaChartFull({ data: rawData = DEFAULT_DATA }: { data?: Point[] }) {
