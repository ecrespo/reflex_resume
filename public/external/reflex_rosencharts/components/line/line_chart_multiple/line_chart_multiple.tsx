...
// Default datasets = the original rosencharts example.
...
export function LineChartMultiple({
  ...
  const data2 = (rawData2 ?? []).map((d) => ({ ...d, date: new Date(d.date) }));
  ...
  let d = line(data);
  let d2 = data2.length > 0 ? line(data2) : null;
