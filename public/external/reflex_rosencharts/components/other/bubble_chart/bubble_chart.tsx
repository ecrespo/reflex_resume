...
type Item = { name: string; sector: string; value: number };
...
export function BubbleChart({ data = DEFAULT_DATA }: { data?: Item[] }) {
  if (!data || data.length === 0) {
    return <div className="relative w-full aspect-square max-w-[18rem] mx-auto" />;
  }
