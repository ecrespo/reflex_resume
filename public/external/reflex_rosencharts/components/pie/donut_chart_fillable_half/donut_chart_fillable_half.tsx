...
// Default value = the original rosencharts example (31% filled).
const DEFAULT_VALUE = 31;

export function DonutChartFillableHalf({ value = DEFAULT_VALUE }: { value?: number }) {
            ...
            <g key={i} clipPath={`url(#fillable-half-donut-clip-${i})`}>
              <path
                className={`stroke-white/30 dark:stroke-zinc-400/10 ${
                  d.data.name === "Empty" ? colors.gray : colors.purple
                }`}
