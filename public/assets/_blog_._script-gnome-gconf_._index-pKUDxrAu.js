...
![17MtNybhdkA9GV3UNS6BTwPcuhjXoPrSzV](/blog/images/17MtNybhdkA9GV3UNS6BTwPcuhjXoPrSzV.png)`))))))),s(`title`,{},`Blog | Script en python que configura los accesos rápidos de teclado a aplicaciones en gnome con gconf`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/script-gnome-gconf)`;var D=n(E);export{D as default};