...
`))))))),s(`title`,{},`Blog | Introducción de Redis con Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/introduccionderedisconpython)`;var D=n(E);export{D as default};