...
`))))))),s(`title`,{},`Blog | Como crear un metapaquete (metapaquete con archivos de configuración)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/comocrearunmetapaquete-1)`;var D=n(E);export{D as default};