...
`))))))),s(`title`,{},`Blog | Reproductor de vídeo con python y kivy`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/reproductordevideoconpythonykivy)`;var D=n(E);export{D as default};