...
`))))))),s(`title`,{},`Blog | Obtener la resolución de la pantalla desde Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/obtenerlaresoluciondelapantalladesdepython)`;var D=n(E);export{D as default};