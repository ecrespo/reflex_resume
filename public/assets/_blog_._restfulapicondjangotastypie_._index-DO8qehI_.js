...
`))))))),s(`title`,{},`Blog | Restful API con Django-tastypie`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/restfulapicondjangotastypie)`;var D=n(E);export{D as default};