...
`))))))),s(`title`,{},`Blog | Crear un paquete python del módulo pywrapper_config`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/crearunpaquetepythondelmodulopywrapperconfig)`;var D=n(E);export{D as default};