...
`))))))),s(`title`,{},`Blog | Cálculo de límites con la librería sympy`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/calculodelimitesconlalibreriasympy)`;var D=n(E);export{D as default};