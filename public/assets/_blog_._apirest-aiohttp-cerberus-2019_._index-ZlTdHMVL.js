...
`))))))),s(`title`,{},`Blog | Validando un API rest asíncrono con Cerberus`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/apirest-aiohttp-cerberus-2019)`;var D=n(E);export{D as default};