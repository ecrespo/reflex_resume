...
`)))))),l(`title`,{},`Blog | Trabajar con un contenedor docker en Python usando docker-py`),l(`meta`,{content:`favicon.ico`,property:`og:image`}))});export{T as default};