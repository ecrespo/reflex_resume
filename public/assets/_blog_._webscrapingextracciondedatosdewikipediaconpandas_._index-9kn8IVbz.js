...
`))))))),s(`title`,{},`Blog | WebScraping (extracción de datos) de wikipedia con Pandas`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/webscrapingextracciondedatosdewikipediaconpandas)`;var D=n(E);export{D as default};