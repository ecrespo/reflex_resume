...
`))))))),s(`title`,{},`Blog | Obtener cotización de criptomonedas y almacenarlas en un archivo csv por medio de pandas`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/obtenercotizaciondecriptomonedasyalmacenarlasenunarchivocsvpormediodepandas)`;var D=n(E);export{D as default};