...
`))))))),s(`title`,{},`Blog | Cómo usar el API de wikipedia con Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python-wikipedia-2019)`;var D=n(E);export{D as default};