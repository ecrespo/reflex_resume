...
`))))))),s(`title`,{},`Blog | Principios S.O.L.I.D. - 4. Principio de segregación de la interfaz. (ISP - Interface segregation principle)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python_solid4)`;var D=n(E);export{D as default};