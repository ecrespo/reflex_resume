...
`))))))),s(`title`,{},`Blog | Árbol de decisión hecho en Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/arboldedecisionhechoenpython)`;var D=n(E);export{D as default};