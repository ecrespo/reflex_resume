...
`))))))),s(`title`,{},`Blog | Instalar Jenkins por medio de Docker y crear una imagen Docker de Jenkins.`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/instalarjenkinspormediodedockerycrearunaimagendockerdejenkins)`;var D=n(E);export{D as default};