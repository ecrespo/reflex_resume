...
`))))))),s(`title`,{},`Blog | Escritura y lectura de un archivo con formato bson usando Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/escrituraylecturadeunarchivoconformatobsonusandopython)`;var D=n(E);export{D as default};