...
`))))))),s(`title`,{},`Blog | Instalando Maemo-SDK shinook en Debian`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/instalandomaemosdk)`;var D=n(E);export{D as default};