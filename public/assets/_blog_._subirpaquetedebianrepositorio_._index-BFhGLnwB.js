...
`))))))),s(`title`,{},`Blog | Subir un paquete Debian (pyching) al repositorio`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/subirpaquetedebianrepositorio)`;var D=n(E);export{D as default};