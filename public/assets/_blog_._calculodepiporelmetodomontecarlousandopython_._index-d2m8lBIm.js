...
`))))))),s(`title`,{},`Blog | Cálculo de Pi por el método MonteCarlo usando Python.`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/calculodepiporelmetodomontecarlousandopython)`;var D=n(E);export{D as default};