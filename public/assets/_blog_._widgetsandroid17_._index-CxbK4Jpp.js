...
`))))))),s(`title`,{},`Blog | Manejando contactos y realizando una llamada con python en Android`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/widgetsandroid17)`;var D=n(E);export{D as default};