...
`))))))),s(`title`,{},`Blog | Variables y placeholders en Tensorflow`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/variablesyplaceholdersentensorflow)`;var D=n(E);export{D as default};