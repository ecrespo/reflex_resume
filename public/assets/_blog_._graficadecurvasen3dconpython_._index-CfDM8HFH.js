...
`))))))),s(`title`,{},`Blog | Gráfica de curvas en 3D con Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/graficadecurvasen3dconpython)`;var D=n(E);export{D as default};