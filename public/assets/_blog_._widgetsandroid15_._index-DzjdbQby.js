...
`))))))),s(`title`,{},`Blog | Tomar una foto desde android con un temporizador desde python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/widgetsandroid15)`;var D=n(E);export{D as default};