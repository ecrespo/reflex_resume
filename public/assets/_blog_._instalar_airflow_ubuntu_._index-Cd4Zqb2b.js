...
`))))))),s(`title`,{},`Blog | Instalación de Airflow en Ubuntu`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/instalar_airflow_ubuntu)`;var D=n(E);export{D as default};