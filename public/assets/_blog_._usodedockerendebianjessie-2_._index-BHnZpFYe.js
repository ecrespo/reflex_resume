...
`))))))),s(`title`,{},`Blog | Uso de docker en Debian Jessie (parte 2)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/usodedockerendebianjessie-2)`;var D=n(E);export{D as default};