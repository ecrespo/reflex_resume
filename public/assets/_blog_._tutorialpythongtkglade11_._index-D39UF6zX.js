...
`))))))),s(`title`,{},`Blog | Crear un Navegador web básico con python+gtk+webkit`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/tutorialpythongtkglade11)`;var D=n(E);export{D as default};