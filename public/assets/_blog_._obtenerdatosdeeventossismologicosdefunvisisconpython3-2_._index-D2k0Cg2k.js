...
`))))))),s(`title`,{},`Blog | Obtener datos de eventos sismológicos de Funvisis con Python3 (segunda versión)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/obtenerdatosdeeventossismologicosdefunvisisconpython3-2)`;var D=n(E);export{D as default};