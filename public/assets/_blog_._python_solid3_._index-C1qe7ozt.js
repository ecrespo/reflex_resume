...
`))))))),s(`title`,{},`Blog | Principios S.O.L.I.D. - 3. Principio de sustitución Liskov. (LSP - Liskov substitution principle)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python_solid3)`;var D=n(E);export{D as default};