...
`))))))),s(`title`,{},`Blog | Volviendo a lo básico, POO en Python ( composición) (parte 9)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/volviendoalobasicopooenpythoncomposicion-9)`;var D=n(E);export{D as default};