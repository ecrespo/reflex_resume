...
`))))))),s(`title`,{},"Blog | Volviendo a lo básico, POO en Python ( diferencia entre `__init__` y `__new__`) (parte 10)"),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/volviendoalobasicopooenpythondiferenciaentreinitynew-10)`;var D=n(E);export{D as default};