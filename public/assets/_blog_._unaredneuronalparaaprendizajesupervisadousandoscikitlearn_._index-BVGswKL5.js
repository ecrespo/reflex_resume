...
`))))))),s(`title`,{},`Blog | Una red Neuronal para aprendizaje supervisado usando Scikit-learn`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/unaredneuronalparaaprendizajesupervisadousandoscikitlearn)`;var D=n(E);export{D as default};