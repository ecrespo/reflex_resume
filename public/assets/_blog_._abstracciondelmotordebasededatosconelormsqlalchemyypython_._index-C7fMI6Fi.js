...
`))))))),s(`title`,{},`Blog | Abstracción del motor de Base de Datos con el ORM Sqlalchemy y python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/abstracciondelmotordebasededatosconelormsqlalchemyypython)`;var D=n(E);export{D as default};