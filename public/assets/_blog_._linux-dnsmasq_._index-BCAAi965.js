...
`))))))),s(`title`,{},`Blog | Usar dnsmasq como servidor DNS cache y local`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/linux-dnsmasq)`;var D=n(E);export{D as default};