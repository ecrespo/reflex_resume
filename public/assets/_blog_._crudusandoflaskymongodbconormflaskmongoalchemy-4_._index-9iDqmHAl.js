...
`))))))),s(`title`,{},`Blog | CRUD usando Flask y MongoDB con ORM Flask-MongoAlchemy (parte 4)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/crudusandoflaskymongodbconormflaskmongoalchemy-4)`;var D=n(E);export{D as default};