...
`))))))),s(`title`,{},`Blog | Sqlalchemy y Elixir: Abstracción de Bases de Datos en Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/sqlalchemyyelixirabstracciondebasesdedatosenpython)`;var D=n(E);export{D as default};