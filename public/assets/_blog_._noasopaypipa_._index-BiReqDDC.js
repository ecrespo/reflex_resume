...
`))))))),s(`title`,{},`Blog | No a SOPA y PIPA`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/noasopaypipa)`;var D=n(E);export{D as default};