...
`))))))),s(`title`,{},`Blog | Widgets en Android con python. Parte 8 (selección simple y botones)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/widgetsandroid8)`;var D=n(E);export{D as default};