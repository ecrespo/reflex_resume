...
`))))))),s(`title`,{},`Blog | Herramientas de Python para desarrollar código seguro y de calidad.`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python-tools-security-quality-code)`;var D=n(E);export{D as default};