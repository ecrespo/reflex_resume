...
`))))))),s(`title`,{},`Blog | Uso de docker en Debian Jessie (parte 1)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/usodedockerendebianjessie-1)`;var D=n(E);export{D as default};