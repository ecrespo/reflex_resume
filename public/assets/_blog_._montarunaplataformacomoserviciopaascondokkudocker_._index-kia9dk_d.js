...
`))))))),s(`title`,{},`Blog | Montar una Plataforma como servicio (PaaS) con Dokku (docker).`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/montarunaplataformacomoserviciopaascondokkudocker)`;var D=n(E);export{D as default};