...
`))))))),s(`title`,{},`Blog | Pruebas unitarias en Python usando mocking y docker`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/pruebasunitariasenpythonusandomockingydocker)`;var D=n(E);export{D as default};