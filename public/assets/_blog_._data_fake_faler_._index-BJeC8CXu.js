...
`))))))),s(`title`,{},`Blog | Generar datos falsos con Faker`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/data_fake_faler)`;var D=n(E);export{D as default};