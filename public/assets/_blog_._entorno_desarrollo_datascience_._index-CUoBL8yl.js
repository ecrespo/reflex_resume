...
`))))))),s(`title`,{},`Blog | Crear entorno de desarrollo para Ciencia de Datos con Anaconda, Jupyter, git y cookiecutter`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/entorno_desarrollo_datascience)`;var D=n(E);export{D as default};