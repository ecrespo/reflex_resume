...
`))))))),s(`title`,{},`Blog | Estructura de datos en python (Grafos)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/estructuradedatosenpythongrafos)`;var D=n(E);export{D as default};