...
`))))))),s(`title`,{},`Blog | Obtener cotización de bitcoin de coinmarketcap con Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/obtenercotizaciondebitcoindecoinmarketcapconpython)`;var D=n(E);export{D as default};