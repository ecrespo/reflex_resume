...
`))))))),s(`title`,{},`Blog | Introducción a anotación y tipos en Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python_typing)`;var D=n(E);export{D as default};