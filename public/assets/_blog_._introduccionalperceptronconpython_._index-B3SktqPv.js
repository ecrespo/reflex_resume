...
`))))))),s(`title`,{},`Blog | Introducción al Perceptron con Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/introduccionalperceptronconpython)`;var D=n(E);export{D as default};