...
`))))))),s(`title`,{},`Blog | Consulta a MongoDB desde Flask (parte 1)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/consultaamongodbdesdeflask-1)`;var D=n(E);export{D as default};