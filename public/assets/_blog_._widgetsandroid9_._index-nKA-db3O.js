...
`))))))),s(`title`,{},`Blog | Widgets en Android con python. Parte 9 (selección multiple)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/widgetsandroid9)`;var D=n(E);export{D as default};