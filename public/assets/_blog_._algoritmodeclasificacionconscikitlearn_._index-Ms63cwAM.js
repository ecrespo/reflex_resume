...
`))))))),s(`title`,{},`Blog | Algoritmo de Clasificación con scikit-learn`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/algoritmodeclasificacionconscikitlearn)`;var D=n(E);export{D as default};