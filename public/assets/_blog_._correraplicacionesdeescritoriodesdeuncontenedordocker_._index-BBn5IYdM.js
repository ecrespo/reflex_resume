...
`))))))),s(`title`,{},`Blog | Correr aplicaciones de escritorio desde un contenedor Docker`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/correraplicacionesdeescritoriodesdeuncontenedordocker)`;var D=n(E);export{D as default};