...
`))))))),s(`title`,{},`Blog | Usar dockerui para la gestión de imágenes y contenedores de Docker`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/usardockeruiparalagestiondeimagenesycontenedoresdedocker)`;var D=n(E);export{D as default};