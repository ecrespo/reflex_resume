...
`))))))),s(`title`,{},`Blog | Iniciando Django con docker usando docker-compose con postgresql como microservicio.`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/iniciandodjangocondockerusandodockercomposeconpostgresqlcomomicroservicio)`;var D=n(E);export{D as default};