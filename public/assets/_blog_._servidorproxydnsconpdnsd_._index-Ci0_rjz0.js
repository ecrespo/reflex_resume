...
`))))))),s(`title`,{},`Blog | Servidor Proxy DNS con pdnsd`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/servidorproxydnsconpdnsd)`;var D=n(E);export{D as default};