...
`))))))),s(`title`,{},`Blog | Reproducir una canción en un Celular con Android desde python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/widgetsandroid16)`;var D=n(E);export{D as default};