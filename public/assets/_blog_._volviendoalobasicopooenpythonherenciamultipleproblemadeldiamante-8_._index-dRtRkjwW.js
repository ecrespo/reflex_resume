...
`))))))),s(`title`,{},`Blog | Volviendo a lo básico, POO en Python ( herencia multiple, problema del diamante) (parte 8)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/volviendoalobasicopooenpythonherenciamultipleproblemadeldiamante-8)`;var D=n(E);export{D as default};