...
`))))))),s(`title`,{},`Blog | Volviendo a lo básico, POO en Python (parte 1)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/volviendoalobasicopooenpython-1)`;var D=n(E);export{D as default};