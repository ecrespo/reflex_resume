...
`))))))),s(`title`,{},`Blog | Sqlite con python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/sqliteconpython)`;var D=n(E);export{D as default};