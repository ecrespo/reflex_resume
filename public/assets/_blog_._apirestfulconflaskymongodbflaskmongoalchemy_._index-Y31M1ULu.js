...
`))))))),s(`title`,{},`Blog | API Rest Ful con Flask y MongoDB (Flask-MongoAlchemy)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/apirestfulconflaskymongodbflaskmongoalchemy)`;var D=n(E);export{D as default};