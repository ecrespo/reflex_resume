...
`))))))),s(`title`,{},`Blog | API Rest Ful con Flask y MongoDB (Flask-MongoAlchemy y Flask-restful)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/apirestfulconflaskymongodb)`;var D=n(E);export{D as default};