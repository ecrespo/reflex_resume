...
`))))))),s(`title`,{},`Blog | Generar gráficos animados de burbuja a lo Gapminer con Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/generargraficosanimadosdeburbujaalogapminerconpython)`;var D=n(E);export{D as default};