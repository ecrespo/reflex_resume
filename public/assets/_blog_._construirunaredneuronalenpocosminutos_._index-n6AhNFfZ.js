...
`))))))),s(`title`,{},`Blog | Construir una red neuronal en pocos minutos`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/construirunaredneuronalenpocosminutos)`;var D=n(E);export{D as default};