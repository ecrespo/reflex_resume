...
`))))))),s(`title`,{},`Blog | Desarrollar código limpio de Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python-clean-python-code)`;var D=n(E);export{D as default};