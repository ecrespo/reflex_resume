...
`))))))),s(`title`,{},`Blog | Compartir repositorios Mercurial por ssh`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/compartirrepositoriosmercurialporssh)`;var D=n(E);export{D as default};