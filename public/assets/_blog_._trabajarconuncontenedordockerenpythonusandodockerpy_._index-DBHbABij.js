...
`))))))),s(`title`,{},`Blog | Trabajar con un contenedor docker en Python usando docker-py`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/trabajarconuncontenedordockerenpythonusandodockerpy)`;var D=n(E);export{D as default};