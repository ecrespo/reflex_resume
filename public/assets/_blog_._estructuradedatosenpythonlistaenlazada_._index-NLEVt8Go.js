...
`))))))),s(`title`,{},`Blog | Estructura de datos en Python (Lista Enlazada)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/estructuradedatosenpythonlistaenlazada)`;var D=n(E);export{D as default};