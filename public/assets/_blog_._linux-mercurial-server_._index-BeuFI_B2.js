...
`))))))),s(`title`,{},`Blog | Compartir repositorios de Mercurial con mercurial-server`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/linux-mercurial-server)`;var D=n(E);export{D as default};