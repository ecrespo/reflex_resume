...
`))))))),s(`title`,{},`Blog | Tutorial de PyQt, crear un navegador web. Parte 6`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/pyqt6)`;var D=n(E);export{D as default};