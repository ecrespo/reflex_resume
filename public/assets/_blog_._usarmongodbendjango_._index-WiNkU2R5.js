...
`))))))),s(`title`,{},`Blog | Usar mongodb en Django`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/usarmongodbendjango)`;var D=n(E);export{D as default};