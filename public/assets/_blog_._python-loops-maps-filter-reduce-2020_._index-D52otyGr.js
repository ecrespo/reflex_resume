...
`))))))),s(`title`,{},`Blog | Sustituir ciclos con map, filter y reduce.`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python-loops-maps-filter-reduce-2020)`;var D=n(E);export{D as default};