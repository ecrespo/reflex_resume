...
`))))))),s(`title`,{},`Blog | Analizando datos del cambio climático y niveles de CO2 en la atmosfera con Python y pandas.`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/analizandodatosdelcambioclimaticoynivelesdeco2enlaatmosferaconpythonypandas)`;var D=n(E);export{D as default};