...
`))))))),s(`title`,{},`Blog | Consulta a MongoDB desde Flask (parte 2 - paginación)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/consultaamongodbdesdeflask-2)`;var D=n(E);export{D as default};