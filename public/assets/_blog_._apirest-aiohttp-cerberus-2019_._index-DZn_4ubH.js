...
├── README.md
├── resources
│\xA0\xA0 ├── api_resources.py
│\xA0\xA0 ├── home.py
│\xA0\xA0 ├── __init__.py
│\xA0\xA0 └── rethink_async.py
└── run.py
\`\`\`
...
![Tabla esquema](/blog/images/2019-apirest-cerberus-5.png)
...
![Consulta válida](/blog/images/2019-apirest-cerberus-1.png)

Ahora se modifica por ejemplo la variable grade a X:

![Consulta inválida](/blog/images/2019-apirest-cerberus-2.png)
...
![Consulta válida](/blog/images/2019-apirest-cerberus-3.png)

Ahora se realiza la consulta modificando la variable grade con el valor de Z:

![Consulta inválida](/blog/images/2019-apirest-cerberus-4.png)
...
`)))))),l(`title`,{},`Blog | Validando un API rest asíncrono con Cerberus`),l(`meta`,{content:`favicon.ico`,property:`og:image`}))});export{T as default};