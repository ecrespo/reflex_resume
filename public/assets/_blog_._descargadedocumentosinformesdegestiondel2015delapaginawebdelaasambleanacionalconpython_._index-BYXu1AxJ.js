...
`))))))),s(`title`,{},`Blog | Descarga de documentos (Informes de gestión del 2015) de la página web de la Asamblea Nacional con Python.`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/descargadedocumentosinformesdegestiondel2015delapaginawebdelaasambleanacionalconpython)`;var D=n(E);export{D as default};