...
`))))))),s(`title`,{},`Blog | Extracción de información de PDFs con python (parte 2).`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/extracciondeinformaciondepdfsconpython-2)`;var D=n(E);export{D as default};