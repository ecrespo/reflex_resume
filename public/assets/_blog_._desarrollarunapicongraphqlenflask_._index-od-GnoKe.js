...
`))))))),s(`title`,{},`Blog | Desarrollar un API con GraphQL en Flask`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/desarrollarunapicongraphqlenflask)`;var D=n(E);export{D as default};