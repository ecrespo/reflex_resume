...
`))))))),s(`title`,{},`Blog | Crear una imagen Docker de Redis`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/crearunaimagendockerderedis)`;var D=n(E);export{D as default};