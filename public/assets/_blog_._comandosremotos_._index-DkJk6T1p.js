...
`))))))),s(`title`,{},`Blog | Ejecutar comandos de forma remota y transferencia de archivos con python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/comandosremotos)`;var D=n(E);export{D as default};