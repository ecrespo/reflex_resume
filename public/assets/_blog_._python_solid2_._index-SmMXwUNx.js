...
`))))))),s(`title`,{},`Blog | Principios S.O.L.I.D. - 2. Principio abierto/cerrado. (OCP - Open/closed principle)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python_solid2)`;var D=n(E);export{D as default};