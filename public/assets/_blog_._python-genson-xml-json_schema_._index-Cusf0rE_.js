...
`))))))),s(`title`,{},`Blog | Generación de esquema JSON de un archivo XML con genson,lxml y xmltodict.`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python-genson-xml-json_schema)`;var D=n(E);export{D as default};