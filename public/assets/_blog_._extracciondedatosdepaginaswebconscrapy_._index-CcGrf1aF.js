...
`))))))),s(`title`,{},`Blog | Extracción de datos de páginas web con scrapy`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/extracciondedatosdepaginaswebconscrapy)`;var D=n(E);export{D as default};