...
`))))))),s(`title`,{},`Blog | Visualización de campo magnético usando streamlit.`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python-streamlit-magnetic-field)`;var D=n(E);export{D as default};