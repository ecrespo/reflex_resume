...
`))))))),s(`title`,{},`Blog | Aplicación que muestra las coordenadas del Celular en google maps en el escritorio`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/tutorialpythongtkglade12)`;var D=n(E);export{D as default};