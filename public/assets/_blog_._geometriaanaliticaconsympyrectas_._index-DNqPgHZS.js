...
`))))))),s(`title`,{},`Blog | Geometría Analítica con Sympy (rectas)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/geometriaanaliticaconsympyrectas)`;var D=n(E);export{D as default};