...
`))))))),s(`title`,{},`Blog | Almacenar los datos de los eventos sismológicos de Funvisis con Python3`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/almacenarlosdatosdeloseventossismologicosdefunvisisconpython3)`;var D=n(E);export{D as default};