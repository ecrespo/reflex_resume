...
`))))))),s(`title`,{},`Blog | Cálculo de derivadas con sympy`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/calculodederivadasconsympy)`;var D=n(E);export{D as default};