...
`))))))),s(`title`,{},`Blog | Análisis de Sentimiento de tweets con Python, TextBlob y tweepy`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/analisisdesentimientodetweetsconpythontextblobytweepy)`;var D=n(E);export{D as default};