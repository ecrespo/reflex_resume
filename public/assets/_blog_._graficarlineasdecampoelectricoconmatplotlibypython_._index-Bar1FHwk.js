...
`))))))),s(`title`,{},`Blog | Graficar líneas de campo eléctrico con matplotlib y Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/graficarlineasdecampoelectricoconmatplotlibypython)`;var D=n(E);export{D as default};