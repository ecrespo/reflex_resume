...
`))))))),s(`title`,{},`Blog | Darle estilo material design a Django (parte 1, el admin)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/darleestilomaterialdesignadjangoadmin-1)`;var D=n(E);export{D as default};