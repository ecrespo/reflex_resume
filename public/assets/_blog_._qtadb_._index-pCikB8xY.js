...
`))))))),s(`title`,{},`Blog | Qtadb programa para controlar un celular Android desde el PC`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/qtadb)`;var D=n(E);export{D as default};