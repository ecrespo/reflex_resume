...
`))))))),s(`title`,{},`Blog | Corrigiendo los reportes generados por lintian de un metapaquete`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/corrigiendolosreportesgeneradosporlintiandeunmetapaquete)`;var D=n(E);export{D as default};