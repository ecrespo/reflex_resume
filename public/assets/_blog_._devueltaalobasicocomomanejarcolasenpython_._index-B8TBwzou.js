...
`))))))),s(`title`,{},`Blog | De vuelta a lo básico, como manejar colas en python.`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/devueltaalobasicocomomanejarcolasenpython)`;var D=n(E);export{D as default};