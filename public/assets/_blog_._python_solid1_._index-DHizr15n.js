...
`))))))),s(`title`,{},`Blog | Principios S.O.L.I.D. - 1. Principio de responsabilidad única (SRP - Single Responsible Principle)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python_solid1)`;var D=n(E);export{D as default};