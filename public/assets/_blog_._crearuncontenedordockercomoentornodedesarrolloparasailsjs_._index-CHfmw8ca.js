...
`))))))),s(`title`,{},`Blog | Crear un contenedor Docker como entorno de desarrollo para sails.js`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/crearuncontenedordockercomoentornodedesarrolloparasailsjs)`;var D=n(E);export{D as default};