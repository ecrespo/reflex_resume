...
`))))))),s(`title`,{},`Blog | Descargar libros de Data Science de la editorial Springer usando Python.`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python-request-wget-springer-1)`;var D=n(E);export{D as default};