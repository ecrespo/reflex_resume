...
`))))))),s(`title`,{},`Blog | API rest ful con Eve (parte 2)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/apirestfulconeve-2)`;var D=n(E);export{D as default};