...
`))))))),s(`title`,{},`Blog | Funciones de activación para un perceptron`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/funcionesdeactivacionparaunperceptron)`;var D=n(E);export{D as default};