...
`))))))),s(`title`,{},`Blog | Geometría Analítica con Sympy (Segmentos)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/geometriaanaliticaconsympysegmentos)`;var D=n(E);export{D as default};