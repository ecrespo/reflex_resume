...
`))))))),s(`title`,{},`Blog | Simulación de circuitos eléctricos con python eispice`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/simulaciondecircuitoselectricosconpythoneispice)`;var D=n(E);export{D as default};