...
`))))))),s(`title`,{},`Blog | Tutorial de PyQt (calendario). Parte 4`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/pyqt4)`;var D=n(E);export{D as default};