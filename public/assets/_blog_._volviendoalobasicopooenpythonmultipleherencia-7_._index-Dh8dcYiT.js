...
`))))))),s(`title`,{},`Blog | Volviendo a lo básico, POO en Python (multiple herencia) (parte 7)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/volviendoalobasicopooenpythonmultipleherencia-7)`;var D=n(E);export{D as default};