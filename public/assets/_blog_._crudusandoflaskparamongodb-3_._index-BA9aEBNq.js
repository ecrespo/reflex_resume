...
`))))))),s(`title`,{},`Blog | CRUD usando Flask para MongoDB (parte 3).`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/crudusandoflaskparamongodb-3)`;var D=n(E);export{D as default};