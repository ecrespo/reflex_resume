...
`))))))),s(`title`,{},`Blog | Programa para el envío de SMS desde Linux con Celular Android (conexión wifi y USB)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/smslinux)`;var D=n(E);export{D as default};