...
`))))))),s(`title`,{},`Blog | Extracción de Datos del PDF de reporte de salud de Cencoex`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/extracciondedatosdelpdfdereportedesaluddecencoex)`;var D=n(E);export{D as default};