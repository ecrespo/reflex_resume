...
`))))))),s(`title`,{},`Blog | Principios S.O.L.I.D. - 5. Principio de inversión de la dependencia. (DIP - Dependency inversion principle)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python_solid5)`;var D=n(E);export{D as default};