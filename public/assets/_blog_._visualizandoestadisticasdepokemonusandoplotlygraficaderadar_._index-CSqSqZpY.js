...
`))))))),s(`title`,{},`Blog | Visualizando estadisticas de pokemon usando plotly ( gráfica de radar)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/visualizandoestadisticasdepokemonusandoplotlygraficaderadar)`;var D=n(E);export{D as default};