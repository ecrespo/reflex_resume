...
`))))))),s(`title`,{},`Blog | Tutorial de Flask parte 2 (plantillas html).`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/tutorialdeflask-2)`;var D=n(E);export{D as default};