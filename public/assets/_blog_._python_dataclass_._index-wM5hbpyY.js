...
`))))))),s(`title`,{},`Blog | Dataclases en Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/python_dataclass)`;var D=n(E);export{D as default};