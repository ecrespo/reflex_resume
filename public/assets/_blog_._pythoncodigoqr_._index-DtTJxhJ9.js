...
`))))))),s(`title`,{},`Blog | Creación de Código QR desde Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/pythoncodigoqr)`;var D=n(E);export{D as default};