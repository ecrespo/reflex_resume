...
`))))))),s(`title`,{},`Blog | Tutorial de Flask parte 3 (formulario web)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/tutorialdeflask-3)`;var D=n(E);export{D as default};