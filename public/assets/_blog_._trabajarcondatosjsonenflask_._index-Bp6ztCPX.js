...
`))))))),s(`title`,{},`Blog | Trabajar con datos JSON en Flask`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/trabajarcondatosjsonenflask)`;var D=n(E);export{D as default};