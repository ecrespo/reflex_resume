...
`))))))),s(`title`,{},`Blog | Gestionar los archivos de configuración en /etc con etckeeper y mercurial`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/linux-etckeeper)`;var D=n(E);export{D as default};