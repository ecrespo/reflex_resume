...
![17MtNybhdkA9GV3UNS6BTwPcuhjXoPrSzV](/blog/images/17MtNybhdkA9GV3UNS6BTwPcuhjXoPrSzV.png)`))))))),s(`title`,{},`Blog | Obtener número de serial y número de versión de Raspberry Pi con Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/obtenernumerodeserialynumerodeversionderaspberrypiconpython)`;var D=n(E);export{D as default};