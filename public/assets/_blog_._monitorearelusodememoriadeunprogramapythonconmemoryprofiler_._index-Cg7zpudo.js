...
![17MtNybhdkA9GV3UNS6BTwPcuhjXoPrSzV](/blog/images/17MtNybhdkA9GV3UNS6BTwPcuhjXoPrSzV.png)`))))))),s(`title`,{},`Blog | Monitorear el uso de memoria de un programa Python con memory_profiler`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/monitorearelusodememoriadeunprogramapythonconmemoryprofiler)`;var D=n(E);export{D as default};