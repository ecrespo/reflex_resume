...
`))))))),s(`title`,{},`Blog | Obtener datos de eventos sismológicos de Funvisis con Python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/obtenerdatosdeeventossismologicosdefunvisisconpython)`;var D=n(E);export{D as default};