...
`))))))),s(`title`,{},`Blog | Captura de información que maneja el sensor del celular Android con python`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/widgetsandroid14)`;var D=n(E);export{D as default};