...
`))))))),s(`title`,{},`Blog | Geometría Analítica con Sympy (triángulos)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/geometriaanaliticaconsympytriangulos)`;var D=n(E);export{D as default};