...
`))))))),s(`title`,{},`Blog | Generando una gráfica en python con matplotlib con PyQT. Parte 11`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/matplotlib11)`;var D=n(E);export{D as default};