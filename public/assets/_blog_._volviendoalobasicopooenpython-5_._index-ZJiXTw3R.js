...
`))))))),s(`title`,{},`Blog | Volviendo a lo básico, POO en Python (parte 5)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/volviendoalobasicopooenpython-5)`;var D=n(E);export{D as default};