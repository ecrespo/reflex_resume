...
`))))))),s(`title`,{},`Blog | Usar memcached para tener datos a la mano`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/memcached_2019)`;var D=n(E);export{D as default};