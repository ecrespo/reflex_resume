...
![17MtNybhdkA9GV3UNS6BTwPcuhjXoPrSzV](/blog/images/17MtNybhdkA9GV3UNS6BTwPcuhjXoPrSzV.png)`))))))),s(`title`,{},`Blog | Profiling de un script python con timeit`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/profilingdeunscriptpythoncontimeit)`;var D=n(E);export{D as default};