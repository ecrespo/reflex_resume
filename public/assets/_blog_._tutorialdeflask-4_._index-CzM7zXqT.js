...
`))))))),s(`title`,{},`Blog | Tutorial de Flask parte 4 (base de datos sqlite3)`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/tutorialdeflask-4)`;var D=n(E);export{D as default};