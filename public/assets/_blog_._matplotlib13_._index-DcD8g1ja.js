...
`))))))),s(`title`,{},`Blog | Generando una gráfica con PyQT y matplotlib (escala semilogaritmica). Parte 13`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/matplotlib13)`;var D=n(E);export{D as default};