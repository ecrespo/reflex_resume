...
`))))))),s(`title`,{},`Blog | Crear un entorno de Integración y Despligue continue con Docker para node.js`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/crearunentornodeintegracionydespliguecontinuocondockerparanodejs)`;var D=n(E);export{D as default};