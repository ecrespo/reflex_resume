...
![17MtNybhdkA9GV3UNS6BTwPcuhjXoPrSzV](/blog/images/17MtNybhdkA9GV3UNS6BTwPcuhjXoPrSzV.png)`))))))),s(`title`,{},`Blog | Extracción de datos de páginas web con scrapy y MongoDB`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/extracciondedatosdepaginaswebconscrapyymongodb)`;var D=n(E);export{D as default};