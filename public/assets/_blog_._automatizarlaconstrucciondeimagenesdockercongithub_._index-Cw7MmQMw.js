...
`))))))),s(`title`,{},`Blog | Automatizar la construcción de imágenes Docker con github`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/automatizarlaconstrucciondeimagenesdockercongithub)`;var D=n(E);export{D as default};