...
`))))))),s(`title`,{},`Blog | Mejorando la velocidad de consultas de DNS con dnsmasq y probar pruebas de diagnostico`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/consultadns1)`;var D=n(E);export{D as default};