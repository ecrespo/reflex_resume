...
`))))))),s(`title`,{},`Blog | Instalar Docker en Debian Jessie`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/instalardockerendebianjessie)`;var D=n(E);export{D as default};