...
`))))))),s(`title`,{},`Blog | Instalar Docker en Debian Stretch (actualización 2017).`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/instalardockerendebianstretchactualizacion2017)`;var D=n(E);export{D as default};