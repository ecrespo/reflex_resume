...
`))))))),s(`title`,{},`Blog | Instalar Docker en Ubuntu Server Xenial 16.04`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/instalardockerenubuntuserverxenial1604)`;var D=n(E);export{D as default};