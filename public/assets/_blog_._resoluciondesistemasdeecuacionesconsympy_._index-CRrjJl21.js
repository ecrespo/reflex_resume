...
`))))))),s(`title`,{},`Blog | Resolución de sistemas de ecuaciones con Sympy`),s(`meta`,{content:`favicon.ico`,property:`og:image`}))}E.displayName=`Component(blog/resoluciondesistemasdeecuacionesconsympy)`;var D=n(E);export{D as default};