Title: Tutorial introductorio de streamlit.
...
En el artículo anterior sobre [visualización de campos magnéticos con streamlit (enlace roto)](https://www.seraph.to/python-streamlit-magnetic-field.html#python-streamlit-magnetic-field) se menciona que en el siguiente artículo (este), se dara un tutorial de streamlit básico.
